    ...
    <main className="relative min-h-screen overflow-hidden bg-cyber-black px-4 py-14 md:py-20">
      ...
      <div className="relative mx-auto w-full max-w-2xl">
        <div className="mb-8 text-center">
          <div className="font-mono text-[13px] font-bold tracking-[0.4em] text-cyber-tan uppercase">
          ...
          <p className="mx-auto mt-4 max-w-lg font-mono text-[14px] leading-relaxed text-cyber-gray md:text-xs">
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-cyber-blue/15 px-5 py-3 font-mono text-[12px] tracking-widest">
          ...
          {sent ? (
            <div className="p-8 text-center">
              ...
              <button
                ...
                className="mt-6 border border-cyber-blue/40 bg-cyber-blue/10 px-4 py-2 font-mono text-[13px] tracking-widest text-cyber-blue hover:bg-cyber-blue/20"
              >
                [ SEND_ANOTHER ]
              </button>
            </div>
            ...
            >
              <label className="block space-y-1.5">
                <span className="font-mono text-[13px] font-bold tracking-wider text-cyber-blue">
                  --company-name
                </span>
                <input
                  value={company}
              ...
              <div className="space-y-1.5">
                ...
                <p className="font-mono text-[12px] tracking-wider text-cyber-gray/50">
        ...
        <div className="mt-8 text-center">
          <a
            href="/"
            className="font-mono text-[13px] tracking-widest text-cyber-gray uppercase transition-colors hover:text-cyber-tan"
          >
            ← back to hackurity
          </a>
        </div>
