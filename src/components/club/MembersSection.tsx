...
export default function MembersSection() {
  ...
  return (
    <section id="members" className="relative mx-auto max-w-6xl px-5 py-24 md:px-8">
      ...
      <p className="mt-5 font-mono text-[14px] leading-relaxed text-cyber-gray">
        {department.blurb}
      </p>
          ...
          {department.people.map((person, index) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h3 className="font-heading text-[15px] leading-relaxed uppercase">
                    {person.name}
                  </h3>
              ...
              <p className="mt-4 border-l border-cyber-tan/40 pl-3 font-mono text-[13.5px] leading-relaxed text-cyber-gray italic">
