...
export default function EventActivityStatus() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-3 font-mono text-[11px] font-bold tracking-[0.16em]">
      ...
      <div className="relative mt-7">
        <div className="mb-2 flex justify-between font-mono text-[10px] tracking-widest text-cyber-gray/75"><span>EVENT SEQUENCE</span><span>{String(activity.index + 1).padStart(2, "0")}/08</span></div>
