                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => setSponsorFormOpen(false)}
                      className="mt-5 border border-cyber-blue/40 bg-cyber-blue/10 px-4 py-2 font-mono text-[13px] tracking-widest text-cyber-blue hover:bg-cyber-blue/20"
                    >
                      [ CLOSE ]
                    </button>
                  </motion.div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <label className="space-y-1.5">
                        <span className="font-mono text-[13px] font-bold text-cyber-blue">--email</span>
                        <input
                          type="email"
                          value={email}
                      ...
                      <label className="space-y-1.5">
                        <span className="font-mono text-[13px] font-bold text-cyber-blue">--phone</span>
                        <input
                          type="tel"
                          value={phone}
                    ...
                    <label className="block space-y-1.5">
                      <span className="font-mono text-[13px] font-bold text-cyber-blue">
                    ...
                    <div>
                      <div className="mb-2 font-mono text-[13px] font-bold text-cyber-blue">
                        --sponsorship-tier
                      </div>
                        ...
                        {TIERS.map((option, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className="relative text-[13px] normal-case text-cyber-gray">{option.note} · {option.benefit}</span>
                    ...
                    <button
                      ...
                      className="w-full border border-cyber-blue/50 bg-cyber-blue/10 px-4 py-3 font-mono text-[13px] font-bold tracking-widest text-white uppercase transition-colors hover:bg-cyber-blue/20 disabled:cursor-not-allowed disabled:opacity-30"
                    >
