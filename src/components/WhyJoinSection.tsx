  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex items-start justify-between">
        ...
        <span className="font-mono text-[12px] font-bold tracking-[0.28em] text-cyber-blue/50">{benefit.id}</span>
      </div>

      <div className="relative z-[1] flex flex-col gap-1.5">
        <span className="font-mono text-[11px] font-bold tracking-[0.3em] text-cyber-tan/70">{`// ${benefit.tag}`}</span>
        <h3 className="font-heading text-[15px] leading-snug text-white uppercase">{benefit.title}</h3>
        <p className="font-mono text-[13.5px] leading-relaxed text-cyber-gray">{benefit.blurb}</p>
      </div>

      <div className="relative z-[1] mt-auto flex items-center gap-2 pt-2 font-mono text-[11px] tracking-widest text-cyber-gray/50">
        <motion.span
      ...
      <AnimatePresence>
        {ping && (
          <motion.span
            ...
            className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center border-2 border-cyber-tan bg-cyber-black/75 font-mono text-[13px] font-bold tracking-[0.28em] text-cyber-tan"
          >
            ✓ ACCESS GRANTED
          </motion.span>
        )}
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        {[
          ...
          <motion.span
            key={i}
            className="absolute -bottom-6 font-mono text-[13px] text-cyber-blue/15"
            style={{ left: b.l }}
      ...
      >
        <span className="flex items-center gap-2 font-mono text-[12px] font-bold tracking-widest text-cyber-tan uppercase">
      ...
      <div className="relative mt-5 overflow-hidden border-y border-cyber-blue/10 bg-cyber-black/40 py-2">
        <motion.div
          className="flex w-max gap-6 whitespace-nowrap font-mono text-[12px] tracking-[0.3em] text-cyber-tan/55"
      ...
      >
        ...
        <div className="relative flex items-center gap-4">
          ...
          />
          <div>
            <p className="font-mono text-[12px] font-bold tracking-[0.25em] text-cyber-tan uppercase">
              Powered by IBM
            </p>
        ...
        <span className="relative flex shrink-0 items-center gap-2 border border-cyber-tan/50 bg-cyber-tan/10 px-4 py-2.5 font-mono text-[13px] font-bold tracking-[0.2em] text-cyber-tan uppercase transition-colors group-hover:bg-cyber-tan/20">
          Lock in your team
          <motion.span
