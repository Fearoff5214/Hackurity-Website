  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="font-mono text-[11px] tracking-widest text-cyber-blue/50 uppercase">
          ...
          >
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="font-mono text-[11px] font-bold tracking-widest text-cyber-blue">
                    // PARTNERSHIP CHANNEL
                  </div>
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => setSponsorFormOpen(false)}
                      className="mt-5 border border-cyber-blue/40 bg-cyber-blue/10 px-4 py-2 font-mono text-[12px] tracking-widest text-cyber-blue hover:bg-cyber-blue/20"
                    >
                      [ CLOSE ]
                    </button>
                  </motion.div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <label className="space-y-1.5">
                        <span className="font-mono text-[12px] font-bold text-cyber-blue">--email</span>
                        <input
                          type="email"
                          value={email}
                      ...
                      <label className="space-y-1.5">
                        <span className="font-mono text-[12px] font-bold text-cyber-blue">--phone</span>
                        <input
                          type="tel"
                          value={phone}
                    ...
                    <label className="block space-y-1.5">
                      <span className="font-mono text-[12px] font-bold text-cyber-blue">
                    ...
                    <div>
                      <div className="mb-2 font-mono text-[12px] font-bold text-cyber-blue">
                        --sponsorship-tier
                      </div>
                        ...
                        {TIERS.map((option, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className="relative text-[12px] normal-case text-cyber-gray">{option.note} · {option.benefit}</span>
                    ...
                    {submitError && (
                      <p className="font-mono text-[11px] tracking-wider text-red-400">{submitError}</p>
                    )}
                    ...
                    <button
                      ...
                      className="w-full border border-cyber-blue/50 bg-cyber-blue/10 px-4 py-3 font-mono text-[12px] font-bold tracking-widest text-white uppercase transition-colors hover:bg-cyber-blue/20 disabled:cursor-not-allowed disabled:opacity-30"
                    >
