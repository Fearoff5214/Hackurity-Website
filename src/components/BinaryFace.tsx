...
export default function BinaryFace() {
  ...
  return (
    <div className="w-full h-full min-h-[350px] relative">
      <span className="absolute top-2 left-2 text-[12px] text-cyber-tan/45 select-none pointer-events-none font-mono">+</span>
      <span className="absolute top-2 right-2 text-[12px] text-cyber-tan/45 select-none pointer-events-none font-mono">+</span>
      <span className="absolute bottom-2 left-2 text-[12px] text-cyber-tan/45 select-none pointer-events-none font-mono">+</span>
      <span className="absolute bottom-2 right-2 text-[12px] text-cyber-tan/45 select-none pointer-events-none font-mono">+</span>
      
      <div className="absolute top-4 left-4 z-10 font-mono text-[11px] text-cyber-blue/60 tracking-wider">
