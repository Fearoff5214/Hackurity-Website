      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-mono font-bold text-cyber-tan border border-cyber-tan/30 bg-cyber-tan/5 px-1.5 py-0.5">
              {gate.id}
            </span>
            <h3 className="font-heading text-[12px] md:text-xs tracking-[0.15em] text-white uppercase">
              {gate.title}
            </h3>
          </div>
