          ...
          <div className="grid gap-px bg-cyber-blue/15 lg:grid-cols-[1.4fr_1fr]">
            <div className="bg-black/70 p-6 md:p-9">
              <div className="flex flex-wrap items-center gap-3">
                <span className="flex items-center gap-2 border border-cyber-tan/50 bg-cyber-tan/10 px-3 py-1.5 font-mono text-[12px] font-bold tracking-widest text-cyber-tan uppercase">
                  <span className="live-dot inline-block h-2 w-2 rounded-full bg-cyber-tan" />
                  Registration open
                </span>
                <span className="font-mono text-[12px] tracking-widest text-cyber-gray">
                  Updated just now
                </span>
              </div>
              ...
              <p className="mt-4 max-w-xl font-mono text-[14.5px] leading-relaxed text-cyber-gray">
              ...
              <dl className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                {FACTS.map((fact) => (
                  <div key={fact.label} className="border-l border-cyber-blue/30 pl-3">
                    <dt className="font-mono text-[11px] tracking-widest text-cyber-blue/70 uppercase">
                      {fact.label}
                    </dt>
                    <dd className="mt-1.5 font-mono text-[13px] leading-relaxed">{fact.value}</dd>
                  </div>
                ))}
              </dl>
              ...
              <div className="mt-9 flex flex-wrap items-center gap-4">
                <Link
                  href="/hackurity"
                  className="group relative inline-flex items-center gap-3 border border-cyber-tan bg-cyber-tan/15 px-6 py-3.5 font-mono text-[13px] font-bold tracking-[0.2em] text-cyber-tan uppercase transition-colors hover:bg-cyber-tan/25"
                >
                  Join Hackurity
                  <span className="transition-transform group-hover:translate-x-1">→</span>
                </Link>
                <span className="font-mono text-[12px] tracking-wide text-cyber-gray">
            ...
            <div className="bg-black/85 p-6 md:p-8">
              ...
              <p className="mt-3 font-mono text-[12px] tracking-wide text-cyber-gray">
                Time left until day one begins.
              </p>

              <div className="mt-7 space-y-4">
                <div>
                  <div className="flex items-baseline justify-between font-mono text-[12px] tracking-widest text-cyber-gray uppercase">
                ...
                <ul className="space-y-2 border-t border-cyber-blue/15 pt-4 font-mono text-[12.5px] leading-relaxed text-cyber-gray">
