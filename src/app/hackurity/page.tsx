      ...
      >
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <Link
            ...
            className="hidden shrink-0 items-center gap-2 border border-cyber-blue/25 px-2.5 py-1.5 font-mono text-[11px] tracking-widest text-cyber-gray uppercase transition-colors hover:border-cyber-tan hover:text-cyber-tan sm:flex"
          >
            ...
            <AnimatePresence initial={false}>
              {!navAttack && (
                <motion.span
                  ...
                  transition={{ duration: 0.35, ease: "easeOut" }}
                  className="overflow-hidden whitespace-nowrap font-heading text-[13px] font-bold tracking-[0.22em] text-white sm:text-xs"
                >
          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                className={`relative shrink-0 py-1 font-mono text-[12px] tracking-widest transition-colors duration-300 hover:text-cyber-tan ${
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 border-t border-cyber-blue/15 pt-3">
                {navLinks.map((link) => (
                  <a
                    ...
                    className={`border px-3 py-3 font-mono text-[13px] tracking-widest transition-colors ${
                      currentSection === link.name
                ...
                <a
                  ...
                  className="col-span-2 border border-cyber-tan/60 bg-cyber-tan/15 px-3 py-3 text-center font-mono text-[13px] font-bold tracking-[0.2em] text-cyber-tan uppercase"
                >
                  Register Now
                </a>
                <Link
                  ...
                  className="col-span-2 flex items-center justify-center gap-1.5 border border-cyber-blue/20 bg-cyber-dark/70 px-3 py-3 text-center font-mono text-[13px] tracking-widest text-cyber-gray uppercase"
                >
      ...
      <main className="max-w-[1280px] mx-auto px-4 md:px-8 py-8 flex flex-col gap-16 md:gap-24 relative z-10">
        ...
        <section id="mission_brief" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/20 relative">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <span className="text-[11px] tracking-[0.3em] text-cyber-tan font-bold flex items-center gap-1.5">
              ...
              <p className="font-mono text-[12px] tracking-wider text-cyber-tan font-bold uppercase">
                ...
                <dl className="grid grid-cols-1 gap-x-4 gap-y-2.5 font-mono text-xs sm:grid-cols-2">
                  {[
                    ...
                    <div key={row.k} className="flex flex-col gap-0.5">
                      <dt className="text-[11px] font-bold tracking-[0.2em] text-cyber-tan uppercase">
                        {row.k}
                      </dt>
            ...
            <div className="flex flex-col gap-4">
              <div className="mt-1">
                <a
                  href="#join_node"
                  className="block w-full px-4 py-2.5 border border-cyber-tan/45 bg-cyber-tan/5 text-cyber-tan font-mono text-[12px] tracking-widest text-center uppercase cursor-pointer hover:bg-cyber-tan/10 hover:shadow-tan transition-all"
                >
                  [ REGISTER NOW]
                </a>
              </div>
          ...
          <div className="hidden lg:col-span-7 lg:flex flex-col justify-center items-center relative overflow-hidden bg-transparent p-4 h-[420px]">
            ...
            <div className="w-full flex items-center justify-between mt-2 px-2 text-[11px] text-cyber-gray font-mono">
        ...
        <section id="ctf_challenges" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/10 relative">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <span className="text-[12px] bg-cyber-tan/10 border border-cyber-tan/30 text-cyber-tan px-1.5 py-0.5 font-bold">TRACKS</span>
                <span className="text-[12px] text-cyber-gray tracking-widest font-bold">03 TRACKS // 2 PROBLEMS EACH</span>
              </div>
              ...
              <ul className="list-none grid grid-cols-1 sm:grid-cols-2 gap-2.5 font-mono text-[13px] text-cyber-gray pl-1 mt-2">
                {DOMAINS.map((domain) => (
                  <li key={domain.id} className="border border-cyber-blue/10 bg-cyber-black/30 p-2.5 hover:border-cyber-tan/40 transition-colors">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      <span className="text-[11px] text-cyber-blue/70">{domain.id}</span>
                    </div>
            ...
            <div className="flex flex-col gap-3 mt-6">
              ...
              <div className="flex items-center justify-between text-[11px] text-cyber-blue/80 font-mono">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center items-center relative py-4 bg-cyber-black/45 border border-cyber-blue/5">
            <div className="absolute top-2 left-2 text-[10px] text-cyber-gray font-mono z-10">
            ...
            <div className="w-full flex items-center justify-between mt-2 px-2 text-[11px] text-cyber-gray">
        ...
        <section id="event_flow" className="flex flex-col gap-8 crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/20 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 border-b border-cyber-blue/15 pb-4">
            <div className="flex flex-col gap-2 max-w-2xl">
              <span className="text-[11px] tracking-widest text-cyber-tan font-bold uppercase">
            ...
            <div className="font-mono text-[11px] tracking-widest text-cyber-tan/70 border border-cyber-tan/15 bg-cyber-tan/5 px-3 py-2">
        ...
        <section id="join_node" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/20 relative">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center gap-5">
            <span className="text-[11px] tracking-widest text-cyber-tan font-bold font-mono">//REGISTER NOW // SECURE REGISTRY</span>
            ...
            <div className="text-[11px] text-cyber-tan/40 leading-normal select-none">SECURE REGISTRY: ALL DATA IS SIGNED AND ENCRYPTED IN TRANSIT.</div>
          </div>

          <div className="lg:col-span-7 min-h-[220px] border border-cyber-blue/15 bg-cyber-black/45 p-5 font-mono text-[13px] text-cyber-blue/80 flex flex-col justify-between relative overflow-hidden">
        ...
        <section id="query_terminal" className="flex flex-col gap-6 crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/20 relative">
          ...
          <div className="flex flex-col gap-2 border-b border-cyber-blue/15 pb-4 md:flex-row md:items-end md:justify-between">
            <div className="flex max-w-2xl flex-col gap-2">
              <span className="text-[11px] font-bold tracking-widest text-cyber-tan uppercase">// SYSTEM_SEQUENCE_NODE_06</span>
            ...
            <div className="border border-cyber-tan/15 bg-cyber-tan/5 px-3 py-2 font-mono text-[11px] tracking-widest text-cyber-tan/70">
              RESPONSE_MODE: LIVE
            </div>
          </div>
          <QueryTerminal />
        ...
        {/* <section id="sponsor_now" className="grid grid-cols-1 lg:grid-cols-12 gap-8 crosshair-corner border border-cyber-blue/10 p-6 bg-cyber-dark/20 relative">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center gap-5">
            <span className="text-[11px] font-bold tracking-widest text-cyber-tan uppercase font-mono">// SYSTEM_SEQUENCE_NODE_07</span>
          ...
          <div className="lg:col-span-6 relative min-h-[220px] border border-cyber-blue/15 bg-cyber-black/45 p-5 font-mono text-[13px] text-cyber-blue/80">
            <div className="absolute inset-0 cyber-grid opacity-60 pointer-events-none" />
            <div className="relative flex items-center justify-between border-b border-cyber-blue/15 pb-3">
        ...
        {/* <section className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch"> */}
          ...
          {/* <BracketFrame>
            <div className="flex flex-col gap-4 relative">
              <div className="flex justify-between items-center text-[12px] text-cyber-tan border-b border-cyber-blue/10 pb-2">
              ...
              <div className="flex flex-col gap-2 mt-2">
                <div className="flex justify-between font-mono text-[12px] text-white">
              ...
              <div className="text-[11px] text-cyber-tan/50 mt-4 leading-normal select-none">
          ...
          <div className="flex items-center gap-3">
            <span className="flex flex-wrap items-center gap-x-2 gap-y-1 font-heading text-xs tracking-[0.2em] font-bold text-white text-glow-tan">
              ...
              <span className="inline-flex items-center gap-2 normal-case">
                <span className="font-mono text-[12px] font-normal tracking-[0.25em] text-cyber-gray lowercase md:text-xs">
                  powered by
                </span>
            ...
            <span className="text-[12px] text-cyber-tan/40">© 2026 REVA Cybersecurity Club. CSE Dept.</span>
          </div>

          {/* Quick diagnostic outputs */}
          <div className="flex items-center gap-6 font-mono text-[11px] text-cyber-blue/60">
            <div>PING: 14MS</div>
            <div>FPS: 60.0</div>
            <div>MEM: 44.82MB</div>
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-cyber-blue/15 bg-cyber-dark/80 px-5 py-4">
              <div>
                <div className="text-[11px] font-mono font-bold tracking-widest text-cyber-tan">// HACKURITY // SECURE REGISTRY</div>
            ...
            {!registrationComplete && (
              <div className="grid grid-cols-3 border-b border-cyber-blue/15 bg-cyber-black text-[11px] font-mono tracking-widest">
            ...
            <div className="overflow-y-auto p-5 md:p-7">
              {registrationComplete ? (
                <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} className="border border-cyber-tan/45 bg-cyber-tan/5 p-6 text-center">
                  ...
                  <button type="button" onClick={() => { setIsRegistrationOpen(false); resetRegistration(); }} className="mt-6 border border-cyber-tan/45 bg-cyber-tan/5 px-4 py-2 font-mono text-[12px] tracking-widest text-cyber-tan transition-colors hover:bg-cyber-tan/10">[ CLOSE_CONSOLE ]</button>
                </motion.div>
              ) : registrationStep === 1 ? (
                <motion.div initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} className="space-y-5">
                  <div><span className="text-[11px] font-bold tracking-widest text-cyber-tan">// TEAM PROFILE</span><p className="mt-2 font-mono text-xs leading-relaxed text-cyber-gray">Compile the identity packet for your Hackurity unit.</p></div>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="space-y-1.5"><span className="text-[12px] font-mono font-bold text-cyber-tan">--team-name</span><input value={teamName} onChange={(event) => setTeamName(event.target.value)} placeholder="Enter team alias..." className={inputClass} /></label>
                    <label className="space-y-1.5"><span className="text-[12px] font-mono font-bold text-cyber-tan">--team-size</span><select value={teamSize} onChange={(event) => updateTeamSize(event.target.value)} className={`${inputClass} cursor-pointer`}><option value="3">3 (TRIO)</option><option value="4">4 (SQUAD)</option></select></label>
                    <label className="space-y-1.5 sm:col-span-2"><span className="text-[12px] font-mono font-bold text-cyber-tan">--university</span><input value={university} onChange={(event) => setUniversity(event.target.value)} placeholder={`${universityPlaceholder || "University node"} |`} className={`${inputClass} placeholder:text-cyber-blue/55`} /></label>
                    <label className="space-y-1.5 sm:col-span-2"><span className="text-[12px] font-mono font-bold text-cyber-tan">--choose-track</span><select value={selectedDomain} onChange={(event) => setSelectedDomain(event.target.value)} className={`${inputClass} cursor-pointer`}><option value="" disabled>SELECT A TRACK...</option>{DOMAINS.map((domain) => <option key={domain.id} value={domain.name}>{`${domain.id} // ${domain.name.toUpperCase()}`}</option>)}</select></label>
                  </div>
                  <div><div className="mb-2 text-[12px] font-mono font-bold text-cyber-tan">--experience-level</div><div className="grid grid-cols-2 gap-2 sm:grid-cols-4">{["BEGINNER", "INTERMEDIATE", "ADVANCED", "EXPERT"].map((level, index) => <motion.button key={level} type="button" onClick={() => setExperienceLevel(level)} whileTap={{ scale: 0.97 }} animate={experienceLevel === level ? { boxShadow: ["0 0 4px rgba(99,102,241,0.2)", "0 0 16px rgba(210,180,140,0.45)", "0 0 4px rgba(99,102,241,0.2)"] } : {}} transition={{ duration: 1.8, repeat: Infinity }} className={`relative overflow-hidden border px-2 py-3 font-mono text-[11px] tracking-wider transition-colors ${experienceLevel === level ? "border-cyber-tan bg-cyber-tan/10 text-cyber-tan" : "border-cyber-blue/20 bg-cyber-dark text-cyber-gray hover:border-cyber-blue/50"}`}><span className="relative">{level}</span><span aria-hidden="true" className="absolute inset-x-0 bottom-0 h-px bg-cyber-blue" style={{ width: `${35 + index * 18}%` }} /></motion.button>)}</div></div>
                </motion.div>
              ) : registrationStep === 2 ? (
                <motion.div initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                  <div><span className="text-[11px] font-bold tracking-widest text-cyber-tan">// MEMBER DETAILS</span><p className="mt-2 font-mono text-xs leading-relaxed text-cyber-gray">Populate a record for each of the {teamSize} assigned operator{teamSize === "" ? "" : "s"}.</p></div>
                  {members.map((member, index) => <div key={index} className="border border-cyber-blue/15 bg-cyber-dark/45 p-4"><div className="mb-4 flex items-center gap-2 text-[12px] font-mono font-bold text-cyber-tan"><span className="h-1.5 w-1.5 bg-cyber-tan animate-pulse" />{index === 0 ? "TEAM LEADER (YOU)" : `TEAM MEMBER ${index + 1}`}</div><div className="grid gap-4 sm:grid-cols-2"><label className="space-y-1.5"><span className="text-[12px] font-mono text-cyber-gray">--name</span><input value={member.name} onChange={(event) => updateMember(index, "name", event.target.value)} className={inputClass} placeholder="Operator name..." /></label><label className="space-y-1.5"><span className="text-[12px] font-mono text-cyber-gray">--email</span><input type="email" value={member.email} onChange={(event) => updateMember(index, "email", event.target.value)} className={inputClass} placeholder="operator@gmail.com" /></label><label className="space-y-1.5"><span className="text-[12px] font-mono text-cyber-gray">--role</span><select value={member.role} onChange={(event) => updateMember(index, "role", event.target.value)} className={`${inputClass} cursor-pointer`}><option value="" disabled>SELECT ROLE...</option>{roleOptions.map((role) => <option key={role} value={role}>{role.toUpperCase()}</option>)}</select></label><label className="space-y-1.5"><span className="text-[12px] font-mono text-cyber-gray">--portfolio</span><input value={member.portfolio} onChange={(event) => updateMember(index, "portfolio", event.target.value)} className={`${inputClass} placeholder:text-cyber-blue/55`} placeholder={`${portfolioPlaceholder || "Portfolio"} |`} /></label></div></div>)}
                </motion.div>
              ) : (
                <motion.div initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} className="space-y-5">
                  <div><span className="text-[11px] font-bold tracking-widest text-cyber-tan">// FINAL VERIFICATION</span><p className="mt-2 font-mono text-xs leading-relaxed text-cyber-gray">Attach a concise project objective, then confirm your operating protocols.</p></div>
                  <label className="block space-y-1.5"><span className="text-[12px] font-mono font-bold text-cyber-tan">--about-yourselves // BRIEF SUMMARY <span className="text-cyber-gray/50 normal-case">(optional)</span></span><textarea value={projectIdea} onChange={(event) => setProjectIdea(event.target.value)} rows={4} placeholder="Tell us a bit about your team, your interests, or what you're hoping to build..." className={`${inputClass} resize-y`} /></label>
                  <div className="grid gap-3 border border-cyber-blue/15 bg-cyber-dark/45 p-4 text-xs font-mono"><div className="text-[11px] tracking-widest text-cyber-blue">PAYLOAD SUMMARY</div><div className="grid gap-2 sm:grid-cols-2 text-cyber-gray"><span>TEAM: <strong className="text-white">{teamName || "UNSET"}</strong></span><span>SIZE: <strong className="text-white">{teamSize} OPERATOR{teamSize === "1" ? "" : "S"}</strong></span><span>TRACK: <strong className="text-white">{selectedDomain || "UNSET"}</strong></span><span>LEVEL: <strong className="text-white">{experienceLevel || "UNSET"}</strong></span></div></div>
                  ...
                  <div className="border border-cyber-blue/15 bg-cyber-dark/45 p-4">
                    <div className="mb-2 text-[11px] tracking-widest text-cyber-blue">--verify-identity</div>
                    {checkingRegistration ? (
                      <p className="font-mono text-[12px] text-cyber-gray/70">Checking registration status…</p>
                    ) : user ? (
                      existingRegistration ? (
                        <div className="space-y-2 text-xs font-mono text-cyber-gray">
                          ...
                          <button type="button" onClick={handleSignOut} className="text-[12px] tracking-widest text-cyber-tan/70 underline underline-offset-2 hover:text-cyber-tan">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          className="border border-cyber-blue/40 bg-cyber-blue/10 px-3 py-2 font-mono text-[12px] font-bold tracking-widest text-cyber-blue uppercase transition-colors hover:bg-cyber-blue/20"
                        >
                          [ SIGN IN WITH GOOGLE ]
                        </button>
                      </div>
            ...
            {!registrationComplete && (
              <div className="border-t border-cyber-blue/15 bg-cyber-dark/70">
                {registrationError && (
                  <div className="border-b border-red-500/30 bg-red-950/30 px-5 py-2 font-mono text-[12px] text-red-400">
                    {registrationError}
                  </div>
                )}
                <div className="flex items-center justify-between gap-3 px-5 py-4">
                  <button type="button" onClick={() => setRegistrationStep((step) => Math.max(1, step - 1))} disabled={registrationStep === 1 || isSubmittingRegistration} className="border border-cyber-blue/20 px-3 py-2 font-mono text-[12px] tracking-widest text-cyber-gray transition-colors hover:border-cyber-blue disabled:cursor-not-allowed disabled:opacity-30">[ BACK ]</button>
                  {registrationStep < 3 ? (
                    <button type="button" onClick={() => setRegistrationStep((step) => step + 1)} disabled={registrationStep === 1 ? !stepOneReady : !membersAreComplete} className="border border-cyber-tan/45 bg-cyber-tan/5 px-3 py-2 font-mono text-[12px] tracking-widest text-cyber-tan transition-colors hover:bg-cyber-tan/10 disabled:cursor-not-allowed disabled:opacity-30">[ CONTINUE ]</button>
                  ) : (
                    <button type="button" onClick={submitRegistration} disabled={!stepThreeReady || isSubmittingRegistration} className="border border-cyber-tan/45 bg-cyber-tan/5 px-3 py-2 font-mono text-[12px] tracking-widest text-cyber-tan transition-colors hover:bg-cyber-tan/10 disabled:cursor-not-allowed disabled:opacity-30">
